          ...
          >
            {showForgotPassword ? (
              ...
              <>
                ...
                <button
                  onClick={() => handleLogin({ email: 'demo@example.com', password: 'demopassword' })}
                  className="w-full mt-6 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 px-4 rounded-lg transition duration-200"
                >
                  Try Demo Account
                </button>
